...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello! My name is **Gabe Love** and I am a sophomore majoring in *data science*. I have been programming for about 4 years now, and am familiar with R already. I actually learned R for an internship I did over this previous summer.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job I think is related to Data Science is a data analyst. Having tools such as Python or R under your belt would be very handy for analysing large sets of company data. ALso, having a good knowledge of statistics and data modeling are necessary when presenting your findings. <a href = "https://www.northeastern.edu/graduate/blog/what-does-a-data-analyst-do/">Data Analyst Job Description</a> ![](news-data-analyst.jpg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am very interested in economic statistics such as income based on area. Covid statistics such as vaccination percantage per area is also very interesting.
